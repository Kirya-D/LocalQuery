...
suite("sessionTitle", () => {
    ...
    test("getter", () => {
        ...
        const actual = indexVM.getSessionTitle()
    ...
    test("setter throws when title is empty", () => {
        indexVM.createNewSession("title does not matter here")
        assert.throws(() => { indexVM.setSessionTitle("") })
    })
})
...
suite("sessionModel", () => {
    ...
    test("getter", () => {
        ...
        const actual = indexVM.getSessionModel()
    ...
    test("getter throws when session is null", () => {
        assert.throws(() => { indexVM.getSessionModel()})
    })

    test("setter", () => {
        indexVM.createNewSession("title does not matter here")
        const newModel = "Expected model"
        indexVM.setSessionModel(newModel)
    ...
    test("setter throws when session is null", () => {
        assert.throws(() => { indexVM.setSessionModel("")})
    })
})
...
suite("sendQuery", () => {
    ...
    test("throws when no session model", () => {
        assert.rejects(async () => { await indexVM.sendQuery("should throw an error")})
    })
